...
mt19937 rngll(chrono::steady_clock::now().time_since_epoch().count());

//const int dx[] = {1, -1, 0, 0};
//const int dy[] = {0, 0, 1, -1};
//unordered_map<char, int> mp = {{'D', 0}, {'U', 1}, {'R', 2}, {'L', 3}, 
	//{'d', 0}, {'u', 1}, {'r', 2}, {'l', 3}};
...
string bin(int x, int fixed = -1) {
	// returns a "fixed" length binary or upto the MSB
	string res(32, '0'); 
	for(int i = 0; i <= 32; ++i)
		if(x & (1 << i))
			res[i] = '1';
